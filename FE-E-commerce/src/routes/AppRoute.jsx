...
const ProfileLayout = lazy(
  () => import("../components/Client/layouts/ProfileLayout")
);
const ProfileInformation = lazy(
  () => import("../pages/Client/Profile/ProfileInformation")
);
const ProfileLocation = lazy(
  () => import("../pages/Client/Profile/ProfileLocation")
);
const ProfileChangePassWord = lazy(
  () => import("../pages/Client/Profile/ProfileChangePassWord")
);
const ProfileCompanyInformation = lazy(
  () => import("../pages/Client/Profile/ProfileCompanyInformation")
);
const ProfileProductloved = lazy(
  () => import("../pages/Client/Profile/ProfileProductloved")
);
const ContactInformation = lazy(
  () => import("../pages/Client/ContactInformation")
);
